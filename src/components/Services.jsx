...
import { assencoAiServices, assencoAiServicesIcons } from "../constants";
import {
  PhotoChatMessage,
  Gradient,
  VideoBar,
    ...
    <Section id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="AssencoAI unlocks the potential of AI-powered applications"
        />
          ...
          <div className="relative z-1 mb-5 flex h-[39rem] items-center overflow-hidden rounded-3xl border border-n-1/10 p-8 lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 ml-auto max-w-[17rem]">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                AssencoAI unlocks the potential of AI-powered applications
              </p>
              <ul className="body-2">
                {assencoAiServices.map((item, index) => (
                  <li
                    key={index}
            ...
            <div className="overflow-hidden rounded-3xl bg-n-7 p-4 lg:min-h-[46rem]">
              <div className="px-4 py-12 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {assencoAiServicesIcons.map((item, index) => (
                    <li
                      key={index}
