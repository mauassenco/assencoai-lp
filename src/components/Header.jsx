...
import assencoAiSymbol from "../assets/assencoAi-symbol.svg";
  ...
  return (
    ...
    >
      <div className="flex items-center px-5 max-lg:py-4 lg:px-7.5 xl:px-10">
        <a className="block flex w-[12rem] items-center xl:mr-8" href="#hero">
          <img src={assencoAiSymbol} width={50} height={50} alt="AssencoAI" />
          <h2 className="h3 relative ml-2 inline-block font-bold">AssencoAI</h2>
        </a>
